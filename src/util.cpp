...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\TourCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\TourCore
    // Mac: ~/Library/Application Support/TourCore
    // Unix: ~/.tourcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TourCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TourCore";
#else
    // Unix
    return pathRet / ".tourcore";
#endif
#endif
}
