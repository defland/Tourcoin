/* src/config/tour-config.h.  Generated from tour-config.h.in by configure.  */
/* src/config/tour-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TOUR_CONFIG_H

#define TOUR_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/TOUR0x0/tour/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tour Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tour Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tourcore"
