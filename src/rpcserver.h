...
extern UniValue etouratefee(const UniValue& params, bool fHelp);
extern UniValue etouratepriority(const UniValue& params, bool fHelp);
extern UniValue etouratesmartfee(const UniValue& params, bool fHelp);
extern UniValue etouratesmartpriority(const UniValue& params, bool fHelp);
