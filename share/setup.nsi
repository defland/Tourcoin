...
!define COMPANY "Tour Core project"
...
OutFile /home/simon/tourcoin/tourcore-${VERSION}-win64-setup.exe
!if "64" == "64"
...
VIAddVersionKey ProductName "Tour Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-tour executable and locales:
    Delete /REBOOTOK $INSTDIR\tour.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\tour-qt.exe
    ...
    WriteRegStr HKCR "tourcore" "URL Protocol" ""
    WriteRegStr HKCR "tourcore" "" "URL:Tour"
    WriteRegStr HKCR "tourcore\DefaultIcon" "" $INSTDIR\tour-qt.exe
    WriteRegStr HKCR "tourcore\shell\open\command" "" '"$INSTDIR\tour-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\tour-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Tour.lnk"
