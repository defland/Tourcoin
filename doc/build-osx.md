...
NOTE: Building with Qt4 is still supported, however, could result in a broken UI. As such, building with Qt5 is recommended. Qt5 5.7 requires C++11 which Tour Core doesn't fully support yet, Qt5 5.6.2 has some other issues, so make sure to install Qt version < 5.6.2 (5.6.1-1 is recommended).
...
1. Clone the GitHub tree to get the source code and go into the directory.
        ...
        sudo git clone https://github.com/Tour-Community/tour.git
        sudo chmod -R 777 tour
        cd tour
...
commands:
    ...
    echo -e "rpcuser=tourrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/TourCore/tour.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/TourCore/tour.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/TourCore/debug.log
