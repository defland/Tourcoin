...
git clone https://github.com/tourcoin/tour
```
...
```bash
    ...
    From https://github.com/tourcoin/tour
...
[tour/gitian.sigs](https://github.com/tourcoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
